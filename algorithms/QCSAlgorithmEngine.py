...
def loadProblem(info , day , diverCount, seed):
    data = ProblemInstanceLoader.loadProblemInstance(day, diverCount, seed, 0)
    data["info"] = info
...
def runAlgorithms(data, frameLength):
    # round += 1
    tmpInstance = ProblemInstance.ProblemInstance(data, 0)
    ...
    currentInstance = DataBatchProvider.fetchCurrentProblemInstance(tmpInstance, frameLength, 0)
    while currentInstance != {}:
        ...
        if lastInstance != {}:
            ...
            if currentInstance["currentTimeOffset"] % 1000 == 0:
            ...
            j = j + 1
        # print(1)
        BaseAlgorithm.run5(currentInstance, j)
        # print(2)
        # print(driver.get_value('RealTotalDistance', 0))
        # print(driver.get_value('OracleTotalDistance', 0))
        # print(driver.get_value('TotalWaitTime', 0))
        ...
        currentInstance = DataBatchProvider.fetchCurrentProblemInstance(tmpInstance, frameLength, 0)
        # print(len(currentInstance['drivers']))
        # print(len(currentInstance['secondDrivers']))

...
# def count_cost(mapping_list, node_cost, close_list, node0):
#     # print("good")
#     # print(mapping_list)
#     # print(node_cost)
#     # print(close_list)
...
#         # print(node0)
#         [node_cost, close_list] = count_cost(mapping_list, node_cost, close_list, node0)  # 计算邻节点
#         # print(close_list)
#     xn = y
#     x0 = x
#     # print(node_cost[0])
...
#         print(NewMapData[i]['NodeId'], NewMapData[j]['NodeId'])
#         node_costs, node_cost, destination_list = Dijkstra(NewMapData[i]['NodeId'], NewMapData[j]['NodeId'], np_edges)
#         template = "StartId:" + str(NewMapData[i]['LocationID']) \
#                     + ",endId:" + str(NewMapData[j]['LocationID']) \
